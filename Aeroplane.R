...
airports <- read.csv("E:/Assignments/Assignments week 7/class/airports.dat", header = FALSE)
...
airline_routes <- read.csv("E:/Assignments/Assignments week 7/class/routes.dat", header=FALSE)
